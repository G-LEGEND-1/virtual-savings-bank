...
const UserDashboard = () => {
  ...
  const showAccountInactiveMessage = () => {
    alert('🔒 ACCOUNT LOCKED\n\nYour account is currently inactive due to unpaid tax fees.\n\nWithdrawals, transfers, and other transactions are temporarily disabled.\n\nPlease contact customer support to resolve this issue.');
  };

  const handleTransfer = () => {
    alert('📋 Transfer Options\n\n1. Transfer to Other Bank\n2. Transfer to VPS Bank\n3. International Transfer\n\nNote: All transfers are disabled due to account inactivity.');
      ...
      <div className="max-w-7xl mx-auto px-3 py-4 mobile-container">
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          ...
          <button 
            ...
            className="bg-white rounded-lg p-3 shadow border border-gray-200 hover:border-purple-300 transition-all"
          >
            <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mb-1 mx-auto">
              <i className="fas fa-exchange-alt text-lg text-purple-500"></i>
            </div>
            <h3 className="font-medium text-gray-800 text-center text-xs">Transfer</h3>
          </button>
        ...
        <div className="grid grid-cols-3 gap-2 mb-6">
          ...
          <button 
            ...
            className="bg-white rounded-lg p-3 shadow border border-gray-200 hover:border-red-300 transition-all"
          >
            <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center mb-1 mx-auto">
              <i className="fas fa-file-invoice-dollar text-lg text-red-500"></i>
            </div>
            <h3 className="font-medium text-gray-800 text-center text-xs">Pay Bill</h3>
          </button>
          ...
          >
            <div className="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mb-1 mx-auto">
              <i className="fas fa-ellipsis-h text-lg text-gray-500"></i>
            </div>
            <h3 className="font-medium text-gray-800 text-center text-xs">More</h3>
          </button>
        </div>
        ...
        <div className="mt-6 p-4 bg-red-50 border border-red-200 rounded-lg">
          <div className="flex items-start">
            <i className="fas fa-exclamation-triangle text-red-500 text-lg mr-3 mt-1"></i>
            <div>
              <h4 className="font-bold text-red-700 text-sm">Account Status: INACTIVE</h4>
