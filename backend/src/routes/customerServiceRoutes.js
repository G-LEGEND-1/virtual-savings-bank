...
let conversations = [
  {
    ...
    messages: [
      ...
      },
      {
        id: 18,
        sender: 'user',
        message: 'I have been home less and job less ever since I lost my both parents since Now last two years I have some inheritance property in my name which was obtained from my grandma. May be we can also think of pledging against loan to settle your claimed tax amount. I\'ll ask my future husband to write to you from his side. He was a banker since 25 years in United Arab Emirates. Now lives outside. I can\'t afford to pay any tax as I have no income What I can do is to authorise your bank higher authority to deduct from my eligible amount. There is no way that I can clear this much huge amount What I can agree if you could finance me a loan for the amount as a separate application keeping this amount as a security against loan. I do not possess any bank AC whatsoever! We need to clear this issues soon. For which please help us to solve it. Now you are saying the due tax amount statement can be given only after we clear all dues ? Customer should be informed prior to the payment in normal case and that is practice. I\'ll also ask our official lawyer to contact you.',
        timestamp: '2026-01-10T22:38:00Z',
        read: true
      },
      {
        id: 19,
        sender: 'customer service',
        message: 'Dear Ms. Fanshaw,\n\nThank you for your detailed message. We acknowledge the personal challenges you have described and we sympathize with your situation. However, we are obligated to respond strictly in line with Virtual Savings Bank (VSB) policies, system protocols, and regulatory requirements.\n\nAfter careful review, we would like to make the following final clarifications:\n\n1. Loan, Pledge, or Deduction Request\n\nPlease be advised that no loan, pledge, financing, or internal deduction can be processed against a frozen or inactive SaveBox Lifetime account.\n\n- An inactive SaveBox account cannot be used as collateral\n- No fees can be debited internally from a frozen SaveBox\n- No loan application can be linked to or secured by an inactive account\n\nThis restriction is system-controlled and cannot be overridden by bank staff or management.\n\n2. Withdrawal & Access Restriction\n\nThe SaveBox Lifetime funds (USD 4,000,000) cannot be accessed, withdrawn, pledged, or restructured until the outstanding tax/maintenance fee is fully settled.\n\nThis requirement exists solely for security, compliance, and beneficiary protection purposes, and applies equally to all SaveBox Lifetime accounts.\n\n3. Tax Statement & Documentation\n\nDue to the current inactive and frozen status of the account, the system does not permit generation or release of official tax statements at this stage.\nAll detailed statements and confirmations become available only after account reactivation.\n\n4. Authorization Limitation\n\nWhile we recognize your position as the legal beneficiary, authorization alone does not grant access to a frozen SaveBox account. Reactivation is the mandatory first step.\n\n5. Final Position of the Bank\n\nTo summarize:\n\n- Outstanding tax/maintenance fee must be paid externally\n- SaveBox account must be reactivated first\n- Only after reactivation can any withdrawal, statement issuance, or further processing occur\n- There is no alternative procedure under VSB policy\n\nWe respect your intention to seek legal advice or further consultation. Please note that our position is entirely based on pre-existing contractual terms agreed upon by Mr. Fanshaw in 2008 and enforced by automated banking systems.\n\nWhen you are ready and able to settle the outstanding tax/maintenance fee, you may contact us again and we will proceed immediately with the reactivation process.\n\nThank you for your understanding.\n\nYours sincerely,\nVSB Support Team\nVirtual Savings Bank (VSB)',
        timestamp: '2026-01-11T12:23:00Z',
        read: false
      }
    ],
    status: 'open',
    createdAt: '2026-01-09T10:30:00Z',
    updatedAt: '2026-01-11T12:23:00Z'
  }
];
